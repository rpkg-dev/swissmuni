...
- The return value of `classifications_col_spec()` has been written to the package file `inst/extdata/col_spec_classifications.Rds` using
  `save_rds(classifications_col_spec(), path = "inst/extdata/col_spec_classifications.Rds")`.
