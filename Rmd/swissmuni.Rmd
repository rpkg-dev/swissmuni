...
-   Setting `format` to anything else than `csv` results in a **XLS response**!
    ...
    -   For the `levels` endpoint, the XLS contains the **column name spec** of the normal API response's `HR_*` columns. The `levels` endpoint is also th
        only one offering the `labelLanguages` URL param (see below).
